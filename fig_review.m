...
function [box] = reliability( X, Y )
    ...
    elseif x_k == 2
        box = {'# Raters','2'; ...
            'X Correl',num2str(x_PCC(1,2),'%.3f'); ...
            'X Alpha',num2str(x_cAlpha,'%.3f'); ...
            '[01] X Mean',num2str(mean(X(:,1)),'%.0f'); ...
            '[02] X Mean',num2str(mean(X(:,2)),'%.0f'); ...
            '[01] X SD',num2str(std(X(:,1)),'%.0f'); ...
            '[02] X SD',num2str(std(X(:,2)),'%.0f'); ...
            'Y Correl',num2str(y_PCC(1,2),'%.3f'); ...
            'Y Alpha',num2str(y_cAlpha,'%.3f'); ...
    ...
    elseif x_k > 2
        ...
        box = [box;{'X Alpha',num2str(x_cAlpha,'%.3f')}];
        for i = 1:x_k
        ...
        box = [box;{'Y Alpha',num2str(y_cAlpha,'%.3f')}];
        for i = 1:y_k
