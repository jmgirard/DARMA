...
%   License: https://darma.codeplex.com/license
    ...
    uicontrol('Style','text', ...
        'Parent',handles.figure_analyze, ...
        'Units','normalized', ...
        'Position',[.05 .29 .90 .04], ...
        'HorizontalAlignment','center', ...
        'FontSize',12, ...
        'String','Inter-Rater Comparison');
    handles.reliability = uitable(...
        'Parent',handles.figure_analyze, ...
        'Units','normalized', ...
        'Position',[.05 .05 .90 .215], ...
    ...
    elseif r > 1
        ...
        reli{5,2} = num2str(RWG(X2,2*mag,'uniform','continuous'));
        reli{5,3} = num2str(RWG(Y2,2*mag,'uniform','continuous'));
    else
        return;
    end
